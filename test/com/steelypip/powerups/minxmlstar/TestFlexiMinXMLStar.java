...
import com.steelypip.powerups.minxmlstar.MinXMLStar.Attr;
...
public class TestFlexiMinXMLStar {
	...
	FlexiMinXMLStar base;
	FlexiMinXMLStar example;
	

	@Before
	public void setUp() throws Exception {
		this.base = new FlexiMinXMLStar( BASE_NAME );
		this.example = new FlexiMinXMLStar( EXAMPLE );
	...
	public void testHasAttributeWithIndex() {
		assertTrue( this.example.hasAttribute( "a1", 0 ) );
		assertFalse( this.example.hasAttribute( "a1", 1 ) );
		assertTrue( this.example.hasAttribute( "a2", 0 ) );
		assertTrue( this.example.hasAttribute( "a2", 1 ) );
		assertFalse( this.example.hasAttribute( "a2", 2 ) );
		assertFalse( this.example.hasAttribute( "a3" ) );
	}
	...
	public void testHasSingleValue() {
		assertTrue( this.example.hasSingleValue( "a1" ) );
		assertFalse( this.example.hasSingleValue( "a2" ) );
		assertFalse( this.example.hasSingleValue( "a3" ) );
	}
	...
	public void testHasKeys() {
		assertFalse( this.base.hasKeys() );
		assertTrue( this.example.hasKeys() );
	}
	...
	public void testHasValues() {
		assertFalse( this.base.hasValues( "a1" ) );
		assertTrue( this.example.hasValues( "a1" ) );
		assertTrue( this.example.hasValues( "a2" ) );
		assertFalse( this.example.hasValues( "a3" ) );
	}
	...
	public void testAttributesAsPairMap() {
		final Map< Pair< @NonNull String, @NonNull Integer >, @NonNull String > m1 = this.base.attributesToPairMap();
		assertTrue( m1.isEmpty() );
		final Map< Pair< @NonNull String, @NonNull Integer >, @NonNull String > m2 = this.example.attributesToPairMap();
